<div>
    ...
    hover:bg-[#1f20a6] transition duration-300 ease-in-out whitespace-nowrap"
            ...
            <div class="flex gap-4">
                <div class="w-2/3 gap-2 flex flex-col ">
                    ...
                    <input wire:model="email" type="email"
                        class="w-full bg-[#1E1E2C] text-white p-3 focus:outline-none focus:ring-0 border border-[#1E1E2C]"
